...
.PHONY: kind-up
kind-up:
	KIND_CLUSTER=$(KIND_CLUSTER) CONTAINER_RUNTIME=$(CONTAINER_RUNTIME) BUILD=$(BUILD) BUILT_COMPONENTS=$(BUILT_COMPONENTS) BUILD_FALLBACK_TAG=$(BUILD_FALLBACK_TAG) bash hack/kind-up.sh
